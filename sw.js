const CACHE = "omens-plapinator-v44";
...
const SHELL = [
  ...
  "./local/assets/smoke-wisp-loop.mp4?v=2",
  "./local/assets/smoke-wisps-ai.png?v=1",
  "./local/assets/smoke-puff.mp4?v=2",
  "./local/assets/smoke-puff-ai.png?v=1",
